...
# Form implementation generated from reading ui file 'positivoNegativoZero.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(60, 20, 671, 81))
        font = QtGui.QFont()
        ...
        self.lineEditNum1.setGeometry(QtCore.QRect(220, 120, 321, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.pushButtonEnviar.setGeometry(QtCore.QRect(280, 380, 201, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.pushButtonEnviar.setFont(font)
        self.pushButtonEnviar.setObjectName("pushButtonEnviar")
        self.labelResultado = QtWidgets.QLabel(self.centralwidget)
        self.labelResultado.setGeometry(QtCore.QRect(150, 210, 461, 131))
        font = QtGui.QFont()
        font.setPointSize(20)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Informe o número para saber se ele é Positivo, Negativo ou Zero"))
