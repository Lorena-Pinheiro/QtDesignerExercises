...
# Form implementation generated from reading ui file 'contagemRegressiva.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(200, 40, 381, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.labelResultado = QtWidgets.QLabel(self.centralwidget)
        self.labelResultado.setGeometry(QtCore.QRect(240, 200, 311, 351))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.pushButtonMostrar.setGeometry(QtCore.QRect(280, 120, 221, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Contagem Regressiva de 10 a 0"))
