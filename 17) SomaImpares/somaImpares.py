...
# Form implementation generated from reading ui file 'somaImpares.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonMostrar.setGeometry(QtCore.QRect(280, 80, 221, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.pushButtonMostrar.setFont(font)
        self.pushButtonMostrar.setObjectName("pushButtonMostrar")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(150, 0, 491, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.labelResultado = QtWidgets.QLabel(self.centralwidget)
        self.labelResultado.setGeometry(QtCore.QRect(160, 160, 461, 351))
        font = QtGui.QFont()
        font.setPointSize(20)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Soma dos números impares entre 1 a 50"))
